...
- 🛡️ Backup APIs (TMDB → Cinemeta, Jikan → AniList) + stale-if-error cache — site never goes blank
...
For anime, the player links to MyAnimeList plus direct searches on Crunchyroll / Netflix.

## 🛡️ Security
- No pirated embeds (VidSrc / MultiEmbed / etc.)
